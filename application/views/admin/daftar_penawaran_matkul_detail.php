    ...
    <div class="widget ">
        ...
        <div class="widget-content">
            <table class="table table-striped table-bordered" id="example">
                ...
                <tbody >
                    <?php $no = 1;
                    foreach ($tabel_penawaran_matkul_detail as $row) {
                        ?>
                        <tr >
                            <td> <?php echo $no; ?> </td>
                            ...
                            <td><a class="btn btn-success" href="<?php echo base_url(); ?>index.php/admin/edit_penawaran_matkul_detail/<?php echo $id_penawaran_matkul; ?>/<?php echo $row->id_detail; ?>"  title="Detail Data"><i class="icon-archive"></i> Edit </a>
                                | <a class="btn btn-danger" href="<?php echo base_url(); ?>index.php/admin/delete_penawaran_matkul_detail/<?php echo $id_penawaran_matkul; ?>/<?php echo $row->id_detail; ?>" class="icon-remove-sign" title="Hapus Data" onclick="return confirm('Apakah anda yakin untuk menghapus data ?');"><i class="icon-remove-sign"></i> Remove</a></td>                       
