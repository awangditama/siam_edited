        ...
        <div class="widget-content">
            ...
            <fieldset>
                <div class="control-group">	
                    <label class="control-label" for="firstname">Tahun Angkatan :</label>
                    <div class="controls">
                        <select name="thn_angkatan" id="thn_angkatan"  required>
                            <option value="">------</option>                            
                            <?php foreach ($option_angkatan as $row) { ?>
                    ...
                    <div class="control-group">											
                        <label class="control-label" for="firstname">Tahun Lulus SMA :</label>
                        <div class="controls">
