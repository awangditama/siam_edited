...
<div class="span12">      		
    <div class="widget ">
        ...
        <div class="widget-content">
            <form id="form_status"  action="<?php echo base_url();?>index.php/mahasiswa/proses_tambah_dosen_wali" method="post" class="form-horizontal">
                <fieldset>
                    ...
                    <div class="control-group">											
                        ...
                        <div class="controls">
                            <select name="dosen" id="semester" required>
                                     <option value="">--------------</option>
